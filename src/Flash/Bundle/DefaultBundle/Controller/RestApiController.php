...
class RestApiController extends Controller {
     ...
     * @Method({"PUT"})
     */
    public function putWinesAction(Request $request) {
     ...
     * @Method({"POST"})
     */
    public function postWinesAction(Request $request) {
     ...
     * @Method({"DELETE"})
     */
    public function deleteWinesAction($id) {
     ...
     * @Method({"GET"})
     */
    public function getWinesAction($id = null) {
